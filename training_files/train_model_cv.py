from constants import NUM_EPOCHS, HF_DS_PATH, BATCH_SIZE, DATASET_EXISTS, NUM_FOLDS, GAUSSIAN_BLUR
...
def main():
    ...
    _, _, testloader = preprocess_data(dataset, BATCH_SIZE)

    # Train models with cross-validation
    train_model_with_cv(dataset, num_epochs=NUM_EPOCHS, batch_size=BATCH_SIZE, num_folds=NUM_FOLDS, test_loader=testloader)

# Execute the cross-validation training process
